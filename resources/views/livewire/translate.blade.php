    ...
    <header class="header">
        ...
        <div class="header__item header__block_rounded header__buttons">
            <label for="search" class="header__block_rounded header__block search">
                ...
                @include('translatable::inc.icon', ['name' => 'search'])
            </label>
            <div
